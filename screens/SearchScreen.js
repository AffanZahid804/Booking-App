...
const SearchScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/*Import Search Result , passing as props  data   */}
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    paddingTop: 50,  // Ensure padding so it doesn't overlap with header/camera
    backgroundColor: "#fff",
  },
  searchBar: {
    padding: 10,
  ...
  input: {
    flex: 1,
    marginRight: 10,  // Ensure space between input and icon
  },
});

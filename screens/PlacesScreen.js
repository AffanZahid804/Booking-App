...
const PlacesScreen = () => {
        ...
        properties: [
          {
            ...
            rating: 3.6,
            address:
              "346, PIA Main Road, Post, Johar Town, 560043 Lahore, Pakistan ",
            oldPrice: 4600,
            newPrice: 3312,
            latitude: "13.0359",
            longitude: "77.6431",
          ...
          },
          {
            ...
            name: "Five-Star Hotel  Lahore",
            rating: 4,
            address:
            "546, PIA Main Road, Post, Johar Town, 560043 Lahore, Pakistan ",
            oldPrice: 4201,
            newPrice: 3327,
            latitude: "12.9784",
            longitude: "77.6408",
          ...
          },
          {
            ...
            rating: 4.2,
            address:
              "Down Town Park, Airport Gate, Defence Int'l Airport Rd, 562157 Lahore, Pakistan",
            oldPrice: 3800,
            newPrice: 3078,
            latitude: "13.1989",
            longitude: "77.7068",
  ...
  return (
               ...
               <Octicons name="arrow-switch" size={24} color="grey" />
                <Text style ={{fontSize:15,fontWeight:"500",marginLeft:8}}>Sort</Text>
                 ...
                 <Text style ={{fontSize:15,fontWeight:"500",marginLeft:8}}>Filter</Text>
                    ...
                    <Fontisto name="map-marker-alt" size={24} color="grey" />
    ...
    {/* filter out Properties so it will display on Place Screen after City Selected on home page  */}
        {sortedData
        ...
        swipeDirection={['up', 'down']}
          swipeThreshold ={200} footer ={<ModalFooter>
               ...
               <Pressable  onPress ={()=>applyFilter(selectedFilter)}
                            ...
                            style ={{
                              ...
                              key = {index}>
                                ...
                                {selectedFilter.includes(item.filter)?(
                                  <FontAwesome name="circle" size={18} color="orange" />
